package com.miaoqi.juc.imoocjiminjuc.example.hystrix;
...
public class HystrixController3 {
    ...
    @HystrixCommand(commandProperties = {@HystrixProperty(name = "circuitBreaker.enabled", value = "true"),  //  熔断器在整个统计时间内是否开启的阀值
